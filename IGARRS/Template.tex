...
\subsection{Harmonic Components}
The two largest harmonic components associated with the time-series of each MODIS pixel were extraced for each band the MODIS time-series 
